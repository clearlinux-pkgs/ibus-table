...
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.13/ibus-table-1.17.13.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.13
cd %{_builddir}/ibus-table-1.17.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748363922
