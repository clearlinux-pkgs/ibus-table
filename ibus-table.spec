...
Version  : 1.17.8
Release  : 11
URL      : https://github.com/mike-fabian/ibus-table/releases/download/1.17.8/ibus-table-1.17.8.tar.gz
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.8/ibus-table-1.17.8.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.8
cd %{_builddir}/ibus-table-1.17.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726087076
