...
Version  : 1.17.4
Release  : 8
URL      : https://github.com/mike-fabian/ibus-table/releases/download/1.17.4/ibus-table-1.17.4.tar.gz
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.4/ibus-table-1.17.4.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.4
cd %{_builddir}/ibus-table-1.17.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707440642
