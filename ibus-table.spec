...
Version  : 1.17.14
Release  : 17
URL      : https://github.com/mike-fabian/ibus-table/releases/download/1.17.14/ibus-table-1.17.14.tar.gz
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.14/ibus-table-1.17.14.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.14
cd %{_builddir}/ibus-table-1.17.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750168418
