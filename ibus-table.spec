...
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.11/ibus-table-1.17.11.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.11
cd %{_builddir}/ibus-table-1.17.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739987891
