...
Version  : 1.17.9
Release  : 12
URL      : https://github.com/mike-fabian/ibus-table/releases/download/1.17.9/ibus-table-1.17.9.tar.gz
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.9/ibus-table-1.17.9.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.9
cd %{_builddir}/ibus-table-1.17.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735082390
