...
Version  : 1.17.6
Release  : 9
URL      : https://github.com/mike-fabian/ibus-table/releases/download/1.17.6/ibus-table-1.17.6.tar.gz
Source0  : https://github.com/mike-fabian/ibus-table/releases/download/1.17.6/ibus-table-1.17.6.tar.gz
...
%prep
%setup -q -n ibus-table-1.17.6
cd %{_builddir}/ibus-table-1.17.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719508461
